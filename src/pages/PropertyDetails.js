          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            <div className="flex items-center gap-x-4 mb-8">
              <div className="w-20 h-20 p-1 border border-gray-300 rounded-full">
                <img src={house.agent.image} alt="agent_img" />
              </div>
              <div>
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <textarea
                ...
                placeholder="Message*"
                defaultValue={`Hello, I am interested in this ${house.type}`}
                required
              ></textarea>
              <div className="flex gap-x-2">
                ...
                <Link
                  to=""
                  className="border border-violet-700 text-violet-700 text-center hover:border-violet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition"
                >
                  Call
                </Link>
              </div>
